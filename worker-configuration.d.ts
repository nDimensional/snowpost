/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3c7c050f3d9935000f049ab15c3ab4a8)
// Runtime types generated with workerd@1.20250813.0 2025-05-07 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		OAUTH_STATE_STORE: KVNamespace;
		OAUTH_SESSION_STORE: KVNamespace;
		WEB_SESSION_STORE: KVNamespace;
		DID_TO_HANDLE: KVNamespace;
		HANDLE_TO_DID: KVNamespace;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PRIVATE_KEY_1" | "AUTH_SECRET_KEY">> {}
}
